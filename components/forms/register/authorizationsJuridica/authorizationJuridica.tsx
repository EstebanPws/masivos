...
export default function AuthorizationJuridica({type, listPaises, onSubmit }: AuthorizationJuridicaProps) {
    ...
    useEffect(() => {        
        const checkAllFieldsFilled = () => {
            let allFieldsFilled = type !== '8' ? facta1 && facta2 && facta3 && facta4 && crs && aut1 && dec1 && terms && cert : terms && cert;
    ...
    }, [facta1, facta2, facta3, facta4, crs, aut1, dec1, terms, cert]);
